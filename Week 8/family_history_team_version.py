...
def print_death_age(people_dict):
    ...
    for people in people_dict: 
       ...
       print(f'{name} was {death_age} years old at death')
...
def print_marriages(marriages_dict, people_dict):
    ...
    for keys in marriages_dict:        

        husband = marriages_dict[keys][0]
        wife = marriages_dict[keys][1]
        wedding_year = marriages_dict[keys][2]
        ...
        print (f'{husband_name} was {husband_age} years old at his wedding in {wedding_year}')
        print (f'{wife_name} was {wife_age} years old at their wedding')
